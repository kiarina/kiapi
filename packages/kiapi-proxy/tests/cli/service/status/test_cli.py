...
from kiapi_proxy.cli.service.status import cli as status_cli
...
def test_service_status_skips_health_when_not_loaded(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    ...
    assert "Health:    skipped" in result.output
