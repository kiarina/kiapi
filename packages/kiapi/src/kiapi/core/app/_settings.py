...
class AppSettings(BaseSettings):
    ...
    user_cache_dir: str | None = Field(
        ...
        description=(
            "Directory where kiapi may store user-specific cache files.\n"
    ...
    user_config_dir: str | None = Field(
        ...
        description=(
            "Directory where kiapi may store user-specific configuration files.\n"
    ...
    user_data_dir: str | None = Field(
        ...
        description=(
            "Directory where kiapi may store user-specific persistent data files.\n"
