...
|  |  | [mlx-community/Qwen3.8-Flash-Next-4bit](https://huggingface.co/mlx-community/Qwen3.8-Flash-Next-4bit) | model weights | Qwen Community License 1.0 | MLX-converted Qwen3.8-Flash-Next. Commercial Model-as-a-Service or AI-work-assistant businesses need a separate license from Qwen. |
