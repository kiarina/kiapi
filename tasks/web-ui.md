...
README での紹介（2026-09-26、`docs/images/web-ui/*.webp`）と 0.8.0 のリリース（同日、PyPI と GitHub Release）は済んだ。
撮り直すときの手順と注意は `docs/playbooks/web-ui-development.md` の「Screenshots for public pages」。
...
- PyPI から入れた kiapi でも UI が配られる（達成。0.8.0 の wheel に同梱）
