"""ERNIE-Image text-to-image request model.
...
class GenerateRequest(BaseModel):
    ...
    model: str | None = Field(
        ...
        description=(
            ...
            "`turbo`; `base` is the higher-quality, slower variant. Aliases such as "
    ...
    steps: int | None = Field(
        ...
        description=(
            ...
            "(turbo 8, base 50). More steps = slower, sometimes higher quality."
        ),
    )
